...
import useTechHoverAnimation from "../../animations/sections/techstack/useTechHoverAnimation.jsx";
function TechStack() {
    const {enter: techEnter, exit: techExit} = useTechHoverAnimation();
    ...
    return (
        <section
            ...
            className="col-span-full md:col-span-7 bg-card border-4 border-border rounded-4xl p-8 md:p-10">
            <h1 className="section-title mb-4.5 font-mono text-secondary-text font-thin text-sm md:text-md">Tech Stack</h1>
            <div className="flex flex-wrap gap-1.5 md:gap-y-3.5 md:gap-x-2">
                ...
                <Pill pillColor="var(--color-blue)">TailwindCSS</Pill>
